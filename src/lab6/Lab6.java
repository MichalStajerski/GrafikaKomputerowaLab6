...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glVertex3f(8.9f, -1.5f, 1.1f);
		gl2.glVertex3f(7.1f, -1.5f, 5.4f);
		gl2.glVertex3f(3.4f, -1.5f, 8.3f);
		gl2.glVertex3f(-1.1f, -1.5f, 8.9f);
		gl2.glVertex3f(-5.4f, -1.5f, 7.1f);
		gl2.glVertex3f(-8.3f, -1.5f, 3.4f);
		gl2.glVertex3f(-8.9f, -1.5f, -1.1f);
		gl2.glVertex3f(-7.1f, -1.5f, -5.4f);
		gl2.glVertex3f(-3.4f, -1.5f, -8.3f);
		gl2.glVertex3f(1.1f, -1.5f, -8.9f);
		...
		gl2.glMaterialfv (gl2.GL_FRONT_AND_BACK, gl2.GL_AMBIENT_AND_DIFFUSE, materials[6],2);
        ...
        gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[color], 6 );      
        gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[color], 7 );
        gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[color], 4 );    
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[color], 0);
        


        float lightColor[] = { 0.4f, 0.4f, 0.4f, 1 };
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_EMISSION, lightColor, 1);
        gl2.glTranslated(14, 4, 0);
        gl2.glEnable(GL2.GL_LIGHT1);
        gl2.glEnable(GL2.GL_LIGHT2);
        glut.glutSolidSphere(3, 13, 7);
        gl2.glPopMatrix();
